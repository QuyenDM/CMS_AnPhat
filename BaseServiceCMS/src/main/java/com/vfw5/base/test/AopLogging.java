...
//            stopWatch.stop();
//
//            logMessage.append(jp.getTarget().getClass().getName());
//            logMessage.append(".");
...
//
//            System.out.println("truong: " + jp.getSignature().getName());
//            System.out.println("argument: " + sb);
            return retVal;
//        } catch (Exception e) {
//            // Log error
