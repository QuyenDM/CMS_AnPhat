...
public class CustomerStatusDS {
    ...
    public CustomerStatusDS() {
    }

    public CustomerStatusDS(Long id) {
        this.id = id;
    }

    public CustomerStatusDS(Long id, Long custId, String taxCode, String service,
            Long staffId, String staffCode, Long status, Date lastUpdated,
            Date createdDate, String staffName, String custName,
            String mineName, String taxAuthority, String lastNotes) {
        this.id = id;
        this.custId = custId;
