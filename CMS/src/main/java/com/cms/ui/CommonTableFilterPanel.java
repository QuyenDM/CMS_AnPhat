...
//        exportButton.setDisableOnClick(true);
    ...
    public void setToolbar(Boolean isEnable){
        toolbar.setVisible(isEnable);
    }
    
    public void setMultiSelected(boolean isMultiSelectAllow){
        mainTable.setMultiSelect(isMultiSelectAllow);
    }
}
