...
public class ComboBoxMultiselect extends AbstractSelect
		implements AbstractSelect.Filtering, FieldEvents.BlurNotifier, FieldEvents.FocusNotifier, Serializable {
	...
	public void setContainerDataSource(Container container) {
		if (isMultiSelect()) {
			if (!(container instanceof BeanItemContainer) && container instanceof Container.Indexed) {
				try {
	...
	protected List<?> getOptionsWithFilter(boolean needNullSelectOption) {
		...
		if (container instanceof BeanItemContainer || !(container instanceof Container.Filterable)
				|| !(container instanceof Container.Indexed) || !(container instanceof Container.Sortable)
		...
		if (isSortingNeeded()) {
			Container.Sortable sortable = (Container.Sortable) container;
		...
		Container.Filter filter = buildFilter(this.filterstring, this.filteringMode);
